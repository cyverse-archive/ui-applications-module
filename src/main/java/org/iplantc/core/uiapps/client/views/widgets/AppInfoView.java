...
public class AppInfoView implements IsWidget {
    ...
    public AppInfoView(final App app) {
        ...
        appDesc.setHTML("<i>" + org.iplantc.core.resources.client.messages.I18N.DISPLAY.description() + ": " + "</i>" + app.getDescription());
    ...
    private void addIntegratorsInfo(final App app, HtmlLayoutContainer c) {
        c.add(new Label(org.iplantc.core.resources.client.messages.I18N.DISPLAY.integratorName() + ": "), new HtmlData(".cell3"));
        c.add(new Label(app.getIntegratorName()), new HtmlData(".cell4"));
        c.add(new Label(org.iplantc.core.resources.client.messages.I18N.DISPLAY.integratorEmail() + ": "), new HtmlData(".cell5"));
        c.add(new Label(app.getIntegratorEmail()), new HtmlData(".cell6"));
    }


    private void addDocLinks(final App app, HtmlLayoutContainer c) {
        c.add(new Label(org.iplantc.core.resources.client.messages.I18N.DISPLAY.help() + ": "), new HtmlData(".cell7"));
        IPlantAnchor doc = new IPlantAnchor(org.iplantc.core.resources.client.messages.I18N.DISPLAY.documentation(), 100, new ClickHandler() {
    ...
    private void addRating(final App app, HtmlLayoutContainer c) {
        c.add(new Label(org.iplantc.core.resources.client.messages.I18N.DISPLAY.rating() + ": "), new HtmlData(".cell9"));
    ...
    private void addPubDate(final App app, HtmlLayoutContainer c) {
        c.add(new Label(org.iplantc.core.resources.client.messages.I18N.DISPLAY.publishedOn() + ": "), new HtmlData(".cell1"));
