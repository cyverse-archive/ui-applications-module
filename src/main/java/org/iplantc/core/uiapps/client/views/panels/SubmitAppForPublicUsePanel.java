...
// import org.iplantc.core.uiapps.client.store.AnalysisToolGroupStoreWrapper;
// import org.iplantc.core.uiapps.client.views.dialogs.CategorySelectionDialog;
 ...
 */
@Deprecated
public class SubmitAppForPublicUsePanel {
    ...
    // * @param closeCallback a command to execute when one of the buttons is clicked. onSuccess is
    // called
